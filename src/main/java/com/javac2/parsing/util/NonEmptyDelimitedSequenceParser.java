...
public class NonEmptyDelimitedSequenceParser<T> extends Parser<List<T>> {
  private final Parser<T> componentParser;
  private final Parser<?> delimiterParser;

  public NonEmptyDelimitedSequenceParser(Parser<T> componentParser, Parser<?> delimiterParser) {
